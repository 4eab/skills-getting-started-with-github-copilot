...
activities = {
    ...
    "Soccer Team": {
        "description": "Team practice and interschool soccer matches",
    ...
    "Drama Workshop": {
        "description": "Acting exercises and stage performance practice",
        "schedule": "Fridays, 4:00 PM - 5:30 PM",
        "max_participants": 16,
        "participants": ["noah@mergington.edu", "emma@mergington.edu"]
    },
    "Math Olympiad": {
        "description": "Prepare for math contests with challenging problems",
